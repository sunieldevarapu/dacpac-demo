...
# Connect to ServiceNow for testing
url = os.environ.get('SNOW_BASE_URL')
...
if response.ok and "logout" in response.url:
    print("Login success")
else:
    print("Login failed")
...
def query_builder(assigned_to: bool) -> str:
    ...
    print("Querry String", query_to_string)
...
print("Calling unassign tasks")
unassign(change_tasks)

print("Calling change tasks")
tasks = change_tasks(assigned_to=False)
print("unassigned tasks", tasks)
