...
octopus_time = "2023-05-06T14:24:12+0000"
formatted_time = format_od_time(octopus_time)
print(formatted_time)

release_number = "2025.5.1"
project_name = "MyProject"
release_id = "Release-123"
time_string = "2025-05-06 14:35:12"
short_description = "Deploy MyProject version 2025.5.1"

# Call scheduled function
is_scheduled = scheduled(release_number, project_name)
...
central_time = to_central_time(time_string, add_delta=True)
print(f"Central time: {central_time}")

# Call find_project_name function
project_name_found = find
