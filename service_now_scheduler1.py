  ...
  deployment-scheduler:
    ...
    steps:
      ...
      - name: Unassign tasks
        ...
        run: |
          python -c "
          from cmadevops_deployment_scheduler.modules.service_now import change_tasks, unassign
      ...
      - name: Get unassigned tasks and schedule
        ...
        run: |
          ...
          from cmadevops_deployment_scheduler.modules.scheduler import schedule
          from datetime import datetime
          import pytz
      ...
      - name: Authorize deployments
        ...
        run: |
          python -c "
          from cmadevops_deployment_scheduler.modules.service_now import change_tasks
          from cmadevops_deployment_scheduler.modules.octopus_deploy import queued_deployments, authorize_deployments
          from datetime import datetime
          import pytz
  ...
  octopus-deploy:
    ...
    steps:
      ...
      - name: Schedule Octopus Deployment
        run: |
          python -c "
          from cmadevops_deployment_scheduler.modules.octopus_deploy import find_project_id, find_release, schedule_release, to_central_time
          import os
          import logging
